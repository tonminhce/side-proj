 ...
 *
 * <p>Cycle path lưu danh sách sheetNameInExcel (hoặc fallback "#<index>" nếu name null) để FE hiển
 * thị thân thiện cho admin.
 *
 * <p>Format message: {@code CIRCULAR_SHEET_LINK: Tiếng Việt — <path>}. Khoá i18n {@code
 * CIRCULAR_SHEET_LINK} dùng để FE/BE error handler dịch.
 */
@Getter
public class CircularSheetLinkException extends RuntimeException {
  ...
  public CircularSheetLinkException(List<String> cycle) {
    ...
    super("CIRCULAR_SHEET_LINK: Phát hiện vòng lặp liên kết sheet — " + String.join(" -> ", cycle));
