 ...
 *
 * <p>Format message: {@code CIRCULAR_COLUMN_DEPENDENCY:<col1>-><col2>-><col1>}. Khoá i18n {@code
 * CIRCULAR_COLUMN_DEPENDENCY} dùng để FE/BE error handler dịch.
 */
@Getter
public class CircularColumnDependencyException extends RuntimeException {
  ...
  public CircularColumnDependencyException(List<String> cycle) {
    ...
    super(
        "CIRCULAR_COLUMN_DEPENDENCY: Phát hiện vòng lặp phụ thuộc cột — "
            + String.join("->", cycle));
