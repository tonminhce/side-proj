...
public class ReportMediaType {
  ...
  private static final Map<ReportType, MediaType> mediaTypeMap =
      ImmutableMap.<ReportType, MediaType>builder()
          .put(ReportType.PDF, MediaType.APPLICATION_PDF)
          .put(ReportType.DOC, MediaType.asMediaType(MimeType.valueOf("application/msword")))
          .put(
              ReportType.DOCX,
  ...
  private static final Map<ReportType, String> extensionMap =
      ImmutableMap.<ReportType, String>builder()
          .put(ReportType.PDF, ".pdf")
          .put(ReportType.DOC, ".doc")
