...
public enum MailType {
    ...
    APPROVE_USER_REGISTRATION("HỒ SƠ THÔNG TIN ĐĂNG KÝ MÃ SỐ VÙNG TRỒNG", "thymeleaf-html/approve-user-registration"),
    REJECT_USER_REGISTRATION("HỒ SƠ THÔNG TIN ĐĂNG KÝ MÃ SỐ VÙNG TRỒNG", "thymeleaf-html/reject-user-registration"),
    ...
    RESTORE_USER_REGISTRATION("HỒ SƠ THÔNG TIN ĐĂNG KÝ MÃ SỐ VÙNG TRỒNG", "thymeleaf-html/restore-user-registration");
