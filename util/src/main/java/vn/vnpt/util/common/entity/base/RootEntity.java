...
public class RootEntity implements Serializable, SoftDeletable {
  @Serial private static final long serialVersionUID = 2583527292636377207L;
  ...
  public void postLoad() {
    if (this.createdAt != null) {
      ...
      this.createdAtFormatted =
          sdf.format(Date.from(this.createdAt.atZone(ZoneId.of("Asia/Ho_Chi_Minh")).toInstant()));
    }
  }

  @Transient private String createdAtFormatted;
}
