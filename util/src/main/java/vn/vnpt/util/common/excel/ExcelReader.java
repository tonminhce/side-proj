...
public class ExcelReader {
    ...
    private <T> ExcelFileInfo<T> readFileDataFromWB(Workbook myWorkBook , Class<T> aClass) throws IOException {
    ...
    private List<ExcelFieldInfo> getHeaderInfo(Map<Integer, String> mapLabelInfo, Class<?> aClass,
                                               ExcelImportConfigInfo config) {
    ...
    private List<ExcelFieldInfo> getNoHeaderInfo(Class<?> aClass,
                                                 ExcelImportConfigInfo config) {
        List<ExcelFieldInfo> listExcelHeaderModel = new ArrayList<>();
        Field[] fields = aClass.getDeclaredFields();
        for (Field field : fields) {
    ...
    public ExcelFileInfo<Map<String,Object>> readFileWithNoClass(XSSFWorkbook wb,ExcelImportConfigInfo config) {
        try {
    ...
    private ExcelFileInfo<Map<String,Object>> readDataFileWithNoClass(Workbook myWorkBook,ExcelImportConfigInfo config) throws IOException {
        ...
        result.setRowDataList((List<Map<String, Object>>) JsonUtil.listMapToListObject(listMapData, aClass));
        return result;
    }
    private List<ExcelFieldInfo> getHeaderInfoWithNoClass(Map<Integer, String> mapLabelInfo,
                                               ExcelImportConfigInfo config) {
        List<ExcelFieldInfo> listExcelHeaderModel = new ArrayList<>();
