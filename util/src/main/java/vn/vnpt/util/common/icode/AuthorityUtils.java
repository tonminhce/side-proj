...
public class AuthorityUtils {
  ...
  public static Set<String> addPermissionPrefix(Collection<String> permission) {
    return (Set)
        permission.stream().map(AuthorityUtils::addPermissionPrefix).collect(Collectors.toSet());
  }
  ...
  public static String extractPermission(String authority) {
    if (Objects.isNull(authority)) {
      ...
      return authority.startsWith("PERMISSION_")
          ? authority.substring("PERMISSION_".length())
          : authority;
    }
  }
