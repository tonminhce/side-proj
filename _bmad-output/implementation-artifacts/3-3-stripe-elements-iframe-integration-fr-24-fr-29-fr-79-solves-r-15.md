...
- **`com.stripe:stripe-java` 28.x API surface** (verify at implementation time; the SDK evolves):
  ...
  - `Stripe.apiVersion = "2025-09-30.clover"` (static setter, called once at startup)
